...
namespace LibrarySystem
{
    public partial class FrmRegister : Form
    {
        ...
        private void btnRegisterOk_Click(object sender, EventArgs e)
        {
            ...
            //再检查输入是否符合格式
            if(textIDcard.Text.Length != 18||
                textPassword.Text.Length !=6||
                textTel.Text.Length != 11||
            ...
            if (userService.Register(textPassword.Text, textName.Text, comboSex.Text, textIDcard.Text, textTel.Text, cmbType2.Text, cmbType1.Text))
            {
                //注册成功
                MessageBox.Show($"注册成功!您的账号为{UserData.newUserId}", "消息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
            else
            {
        ...
        private void cmbType1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
